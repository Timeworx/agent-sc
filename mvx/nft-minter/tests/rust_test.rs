...
use nft_minter::nft_attributes_builder::{NftAttributesBuilderModule, COLLECTION_HASH_LEN, NftId};
    ...
    nm_setup
        ...
        .execute_query(&nm_setup.nm_wrapper, |sc| {
            ...
            let nft_main_file_uri =
                sc.build_nft_main_file_uri(&coll_hash, &NftId::UniqueId(2), &managed_buffer!(b"jpg"));
            ...
            let nft_json_file_uri = sc.build_nft_json_file_uri(&coll_hash, &NftId::UniqueId(2));
