    ...
    + crate::events::EventsModule
{
    ...
    #[endpoint(setUniqueFilename)]
    fn set_unique_filename(
        &self,
        brand_id: BrandId<Self::Api>,
        attribute_spec_file_name: ManagedBuffer,
    ) {
        self.attribute_spec_file_name(&brand_id).set(attribute_spec_file_name);
    }
        ...
        match result {
            ManagedAsyncCallResult::Ok(token_id) => {
                ...
                for tier_info in cb_info.tier_info_entries {
                    ...
                    self.next_id(&brand_id, &tier_info.tier)
                        .set(0);
