...
pub trait CommonStorageModule {
    #[view(isManaged)]
    #[storage_mapper("isManaged")]
    fn is_managed(&self) -> SingleValueMapper<bool>;

    #[view(attributeSpecFileName)]
    #[storage_mapper("attributeSpecFileName")]
    fn attribute_spec_file_name(&self, brand_id: &BrandId<Self::Api>) -> SingleValueMapper<ManagedBuffer>;
